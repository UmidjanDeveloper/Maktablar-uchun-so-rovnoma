 ...
 *
 *    bola yozgan          katalogda        nega topilmagan
 *    ---------------------------------------------------------
 ...
 *
 *  Ya'ni ayb bolada emas — qidiruv oddiy "ichida bormi?"
 ...
 * Bola "Yangi MFY" deb yozsa, katalogdagi "Yangi" bilan
 ...
 * bola qaysi birini tanlashini oldindan bilib bo'lmaydi:
